...
>
> 当前阶段：Milestone 3.2 pure AI Builder OS package surface。npm 包名暂不重命名，避免破坏既有安装、验证和下游消费链路；对外叙事、manifest、installer、adapter 和 pack gate 均以 AI Builder OS 为主身份。
>
